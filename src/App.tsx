...
const MOOD_QUESTIONS: MoodQuestion[] = [
  ...
  {
    question: "💎 想像一下，如果你被邀請參加 SEVENTEEN 下一場世運體育場演唱會，你最想定格在什麼畫面上？",
    options: [
      { text: "💥 巨型藍牙中控手燈瘋狂閃爍，全場大唱《HOT》和無限克拉安可《아주 NICE》蹦迪", description: "狂熱現場！要和十三位成員一起燃燒熱烈青春，感受心跳加速的震撼！", mood: "energized" },
      { text: "😭 燈光暗下、成員與克拉圍成一個圓合唱《Kidult》及《Circles》全場淚崩", description: "靈魂相擁！在眼淚與歌聲中得到毫無保留的治癒和愛，撫平內心褶皺", mood: "healing" },
      { text: "🎬 串場 VCR 或 Talk 時間，聽夫碩順（BSS）與全體成員搞笑鬥嘴、爆笑百出", description: "快樂無限！聽這群人隨口丟包袱、神級接梗，笑出眼淚才是演唱會最極致的享受", mood: "laugh" },
      { text: "🌌 溫柔安靜的藍色克拉海中，靜靜聆聽 Vocal Team 宛如天籟的清唱和聲", description: "心靈洗滌！融化在通透、放空而溫暖的湛藍旋律之中，沉浸於純粹空靈的感動", mood: "calm" }
    ]
  },
  {
    question: "☕ 在一個悠悠的半日午後，你最嚮往哪種完美的個人內心充能方式？",
    options: [
      { text: "🔥 戴上耳機放大音量，跟著動感舞曲來一場說走就走的自主節奏練習", description: "動起來！流汗就是最極致、最過癮、充滿熱血的釋放壓力配方！", mood: "energized" },
      { text: "📖 找一家安靜街角、陽光灑落的貓咪咖啡廳享受閱讀或精緻手作", description: "溫柔慢時光，慢慢感受溫潤的生命治癒力量，重整思緒", mood: "healing" },
      { text: "🍿 在被窩裡點一份美味外送，瘋狂刷熱門實境綜藝直到笑到肚子痛", description: "大笑解千愁！無腦狂歡，把所有煩惱通通隨著捧腹大笑而煙消雲散", mood: "laugh" },
      { text: "🎧 在細雨中戴上降噪耳機，閉著眼睛聆聽雨聲與純鋼琴/Lo-Fi 旋律", description: "心靈放空，享受極致孤獨而高雅、毫無干擾的寧靜深思", mood: "calm" }
    ]
  },
  {
    question: "🧭 假如你即將代表 SEVENTEEN 去探索另一個宇宙，你會為團隊帶上哪個神秘感應裝備？",
    options: [
      { text: "🚀 強力高能推進器，帶領團隊以光速向前衝鋒", description: "滿滿衝勁與勇氣，隨時隨地準備高燃開唱、閃耀奪取全宇宙目光！", mood: "energized" },
      { text: "💖 一個能夠儲存所有克拉愛與思念的永久溫暖防護罩", description: "不畏天寒地凍與考驗，無論走到哪裡都有最溫煦的治癒守護力量", mood: "healing" },
      { text: "🎭 只要打開就會自動播放高能爆笑綜藝與搞怪模仿的小喇叭", description: "絕不沉悶！用橫掃宇宙的十七式綜藝笑料，把一切未知挑戰化為超高能笑聲", mood: "laugh" },
      { text: "🔮 釋放舒緩薄荷香氣與自然溪流聲的無重力靜音水晶球", description: "放慢漫步節奏，引導大家在清冷的璀璨星際之中佛系放空與休養", mood: "calm" }
    ]
  }
];
